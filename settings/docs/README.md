...
| [anyflow/RESULTS-REVEAL-STUDY.md](anyflow/RESULTS-REVEAL-STUDY.md) | バリエーション検討・現行12案（No.02〜05、09〜16）。背景統一、初回のピクト主体案をNo.16で復元。縦スクロール、ズーム＋横移動、用途名強調、発火式タイピング、V4ピクト・スロット、ブックマークと削除・復元、画面占有率と移植用文面 |
