...
function Card({ card }: { card: GourmetCard }) {
  ...
  return (
    <div
      ...
      onClick={() => {
        if (hasDetail) navigateTo(`/gourmet/${card.id}`); /* 2026-09-26 ページ移動は全部 PageTransition を通す */
      }}
    >
      <img
        src={card.img}
