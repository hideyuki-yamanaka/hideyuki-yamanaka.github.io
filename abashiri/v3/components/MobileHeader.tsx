...
/* ── ドロワー（ハンバーガーを押すと出る中身）─────────────
   【2026-09-26 ヒデさん指示】
     「テキストを入れただけの殺風景なデザイン。作字のロゴ（吹き出しの上に網走市観光サイト
       が付いているセット）を持ってきて、ドロワーの中を3バリエーション」
   → 3案（空に浮かぶ作字／白い紙に番号／写真のタイル）を作り、ヒデさんの選定で
     【案1「空に浮かぶ作字」に確定】。案2・案3 と、調整パネルの切り替えは同日に削除した */

/* 開く時の動き：ふわっとブラーが晴れる。項目は少しずつ遅れて出る */
        ...
        {open && (
          ...
          >
            ...
            <button
              ...
              aria-label="閉じる"
              className="fixed right-6 top-5 z-10 flex size-9 items-center justify-center text-white"
            >
            ...
            {/* 作字を大きく中央に、メニューは白い文字で縦並び（旧・案1「空に浮かぶ作字」） */}
